  ...
  >
    <div class="panel collection-panel">
      <div class="section-head">
        ...
        <div class="filter-row">
          <select v-model="rarityFilter" @change="resetUserCards">
            ...
            <option v-for="rarity in rarityOrder" :key="rarity" :value="rarity">
              {{ rarity }}
            </option>
          </select>
          ...
          >
            ...
            >
              <LoaderCircle v-if="busy.bulkDecompose" :size="16" class="spin" />
      ...
      <div v-else-if="!userCards?.list.length" class="empty-state">
        ...
        <span>{{ bagNewOnly ? "最近获得会显示" : "抽卡后加入背包" }}</span>
      </div>
          ...
          <div class="card-face">
            ...
            <div class="card-content">
              ...
              <div class="tag-row">
                ...
                <span>{{ battleRoleLabel(card.battleRole) }}</span>
                <span v-if="card.potentialGrade">
                  {{ potentialLabel(card.potentialGrade) }}
                </span>
                ...
                <span v-if="card.listedCount">挂售 {{ card.listedCount }}</span>
